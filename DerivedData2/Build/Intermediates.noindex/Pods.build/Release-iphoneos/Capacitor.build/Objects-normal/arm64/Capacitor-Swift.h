...
@optional
- (void)injectScriptBeforeLoadWithPath:(NSString * _Nonnull)path;
@required
...
@interface CAPConsolePlugin : CAPPlugin <CAPBridgedPlugin>
...
@interface CAPCookiesPlugin : CAPPlugin <CAPBridgedPlugin>
@property (nonatomic, readonly, copy) NSString * _Nonnull identifier;
@property (nonatomic, readonly, copy) NSString * _Nonnull jsName;
@property (nonatomic, readonly, copy) NSArray<CAPPluginMethod *> * _Nonnull pluginMethods;
- (void)load;
...
@interface CAPHttpPlugin : CAPPlugin <CAPBridgedPlugin>
@property (nonatomic, readonly, copy) NSString * _Nonnull identifier;
@property (nonatomic, readonly, copy) NSString * _Nonnull jsName;
@property (nonatomic, readonly, copy) NSArray<CAPPluginMethod *> * _Nonnull pluginMethods;
- (nonnull instancetype)initWithBridge:(id <CAPBridgeProtocol> _Nonnull)bridge pluginId:(NSString * _Nonnull)pluginId pluginName:(NSString * _Nonnull)pluginName OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("This initializer is deprecated and is not suggested for use. Any data set through this init method will be overridden when it is loaded on the bridge.");
...
SWIFT_CLASS_NAMED("CAPSystemBarsPlugin")
@interface CAPSystemBarsPlugin : CAPPlugin <CAPBridgedPlugin>
@property (nonatomic, readonly, copy) NSString * _Nonnull identifier;
@property (nonatomic, readonly, copy) NSString * _Nonnull jsName;
@property (nonatomic, readonly, copy) NSArray<CAPPluginMethod *> * _Nonnull pluginMethods;
- (void)load;
...
@interface CAPWebViewPlugin : CAPPlugin <CAPBridgedPlugin>
@property (nonatomic, readonly, copy) NSString * _Nonnull identifier;
@property (nonatomic, readonly, copy) NSString * _Nonnull jsName;
@property (nonatomic, readonly, copy) NSArray<CAPPluginMethod *> * _Nonnull pluginMethods;
- (nonnull instancetype)initWithBridge:(id <CAPBridgeProtocol> _Nonnull)bridge pluginId:(NSString * _Nonnull)pluginId pluginName:(NSString * _Nonnull)pluginName OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("This initializer is deprecated and is not suggested for use. Any data set through this init method will be overridden when it is loaded on the bridge.");
...
/// An internal class adopting a public protocol means that we have a lot of <code>public</code> methods
...
/// <code>path</code> is relative to the public folder
- (void)injectScriptBeforeLoadWithPath:(NSString * _Nonnull)path;
/// Eval JS for a specific plugin.
/// <code>js</code> is a short name but needs to be preserved for backwards compatibility.
- (void)evalWithPlugin:(CAPPlugin * _Nonnull)plugin js:(NSString * _Nonnull)js;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull capacitorViewDidAppear;)
+ (NSNotificationName _Nonnull)capacitorViewDidAppear SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull capacitorViewWillTransition;)
+ (NSNotificationName _Nonnull)capacitorViewWillTransition SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)webView:(WKWebView * _Nonnull)webView requestDeviceOrientationAndMotionPermissionForOrigin:(WKSecurityOrigin * _Nonnull)origin initiatedByFrame:(WKFrameInfo * _Nonnull)frame decisionHandler:(void (^ _Nonnull)(WKPermissionDecision))decisionHandler;
